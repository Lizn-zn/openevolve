...
async def run_with_timeout(
    ...
    Args:
        ...
        *args: Arguments to pass to the coroutine
        timeout_error_value: Value to return on timeout (default: {"combined_score": 0.0, "error": 0.0, "timeout": 1.0})
    ...
    if timeout_error_value is None:
        timeout_error_value = {"combined_score": 0.0, "error": 0.0, "timeout": 1.0}
